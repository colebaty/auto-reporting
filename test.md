...
![replace-me-5](img/replace-me-5.png)
...
![replace-me-6](img/replace-me-6.png)
...
![Pasted image 20230622165222](img/Pasted%20image%2020230622165222.png)

We'll check these out later.

### users with shell access
![Pasted image 20230622165358](img/Pasted%20image%2020230622165358.png)

### SUID binaries
![Pasted image 20230622165547](img/Pasted%20image%2020230622165547.png)
There's not much that can be done with the SUID binaries.  Attempts to abuse `sudo` fail.
![Pasted image 20230622165645](img/Pasted%20image%2020230622165645.png)
...
![Pasted image 20230622131937](img/Pasted%20image%2020230622131937.png)
...
![Pasted image 20230622170243](img/Pasted%20image%2020230622170243.png)
...
![Pasted image 20230622171034](img/Pasted%20image%2020230622171034.png)

Let's check out `/dev/shm`

![Pasted image 20230622175448](img/Pasted%20image%2020230622175448.png)
...
![Pasted image 20230622182706](img/Pasted%20image%2020230622182706.png)
...
Can we abuse this?
![Pasted image 20230622184222](img/Pasted%20image%2020230622184222.png)
...
![Pasted image 20230622213326](img/Pasted%20image%2020230622213326.png)
...
![Pasted image 20230622214002](img/Pasted%20image%2020230622214002.png)
...
chmod u+x /tmp/bash
```
![Pasted image 20230622214803](img/Pasted%20image%2020230622214803.png)
...
![Pasted image 20230622215315](img/Pasted%20image%2020230622215315.png)
But we can generate an ssh key pair.

![Pasted image 20230622215746](img/Pasted%20image%2020230622215746.png)
...
![Pasted image 20230622220246](img/Pasted%20image%2020230622220246.png)
...
![Pasted image 20230622220501](img/Pasted%20image%2020230622220501.png)

### user flag
![Pasted image 20230622220701](img/Pasted%20image%2020230622220701.png)
...
![Pasted image 20230623105757](img/Pasted%20image%2020230623105757.png)
...
![Pasted image 20230622225105](img/Pasted%20image%2020230622225105.png)
...
![Pasted image 20230622223906](img/Pasted%20image%2020230622223906.png)
...
![Pasted image 20230622230219](img/Pasted%20image%2020230622230219.png)

Create a new notebook, and do some testing.
![Pasted image 20230623090514](img/Pasted%20image%2020230623090514.png)
We have command execution as Jovian.

Let's see if we can get a reverse shell:

![Pasted image 20230623091044](img/Pasted%20image%2020230623091044.png)
![Pasted image 20230623091131](img/Pasted%20image%2020230623091131.png)
...
![Pasted image 20230623092621](img/Pasted%20image%2020230623092621.png)
...
![Pasted image 20230623094119](img/Pasted%20image%2020230623094119.png)
...
![Pasted image 20230623094325](img/Pasted%20image%2020230623094325.png)

Since we're trying to get to root, look for any files on the system named `config.json` which are also owned by root.
![Pasted image 20230623094809](img/Pasted%20image%2020230623094809.png)
...
![Pasted image 20230623095621](img/Pasted%20image%2020230623095621.png)
...
![Pasted image 20230623101259](img/Pasted%20image%2020230623101259.png)
...
![Pasted image 20230623101535](img/Pasted%20image%2020230623101535.png)
